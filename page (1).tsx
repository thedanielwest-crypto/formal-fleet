...
export default function Home() {
  return (
    <div>
      ...
      <section className="bg-[linear-gradient(180deg,rgba(13,27,42,0.93),rgba(13,27,42,0.86)_55%,rgba(22,41,62,0.96)),url('/photos/brand-hero.jpg')] bg-cover bg-center bg-no-repeat text-white px-6 md:px-14 pt-20 pb-16 text-center">
